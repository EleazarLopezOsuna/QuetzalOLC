...
%{
    import * as type from "../system/type.js";
    import {error, error_arr, error_type} from "../system/error.js";

    import {arithmetic, arithmetic_type} from '../expression/arithmetic.js';
    import {relational, relational_type} from '../expression/relational.js';
    import {logic, logic_type} from '../expression/logic.js';

    import native from '../literal/native.js';
%}
